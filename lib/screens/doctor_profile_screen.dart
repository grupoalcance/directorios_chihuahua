...
import '../widgets/custom_app_bar.dart'; // <-- IMPORTAMOS LA BARRA INTELIGENTE
...
class _DoctorProfileScreenState extends State<DoctorProfileScreen> {
                ...
                ElevatedButton(
                  onPressed: guardando
                      ...
                      : () async {
                          ...
                          if (userDoc.exists) {
                            nombrePaciente =
                                '${userDoc['nombre']} ${userDoc['apellidos']}'
                                    .trim();
                          }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDoctorBlogSection(screenWidth, nombreCompleto, doctorId),
  ...
  // --- SECCIÓN DE BLOG CONECTADA A SUB-COLECCIÓN ---
