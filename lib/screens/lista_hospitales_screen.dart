              ...
              Center(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      // =========================================================================
                      // 🏢 ENCABEZADO PREMIUM DE HOSPITALES Y CLÍNICAS
                      // =========================================================================
                      Text(
                        'Hospitales y Clínicas en ${AppConfig.ciudadesActivas[0]}',
              ...
              SeccionEnlacesCruzados(
                ...
                enlacesPorCiudad: {
                  for (var ciudad in ciudadesPrincipales)
                    ciudad: [
                      'Hospitales con Urgencias en $ciudad',
                      'Clínicas de Especialidades en $ciudad',
                      'Maternidad en $ciudad',
                      'Centros Médicos Quirúrgicos en $ciudad',
                      'Sanatorios Privados en $ciudad',
                    ],
                },
